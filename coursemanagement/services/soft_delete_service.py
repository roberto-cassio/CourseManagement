...
Dessa forma, para garantir a consistência entre as deleções, posso chamar o método destroy do próprio Courses, o que acaba gerando o efeito cascata esperado
'''
